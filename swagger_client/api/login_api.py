...
class LoginApi(object):
    ...
    def login_post(self, body, **kwargs):  # noqa: E501
        ...
        Login to website with user & password. get a token.  # noqa: E501
        ...
        :param LoginData body: Login with user & password (required)
    ...
    def login_post(self, email, password, **kwargs):  # noqa: E501
        """Login to website.  # noqa: E501

        Login to website with user & password. get a token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_post(email, password, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.login_post_with_http_info(email, password, **kwargs)  # noqa: E501
        else:
            (data) = self.login_post_with_http_info(email, password, **kwargs)  # noqa: E501
            return data

    def login_post_with_http_info(self, email, password, **kwargs):  # noqa: E501
        """Login to website.  # noqa: E501

        Login to website with user & password. get a token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_post_with_http_info(email, password, async_req=True)
        >>> result = thread.get()
        ...
        if ('email' not in params or
            ...
            raise ValueError("Missing the required parameter `email` when calling `login_post`")  # noqa: E501
